/**
 * config.js — Public browser configuration constants.
 *
 * These are public-safe browser keys. Never put the service key
 * or JWT secret here. This file is safe to commit to the repository.
 *
 * Before deploying, replace the placeholder values below with your
 * actual Supabase project URL, anon key, and Render backend URL.
 */
